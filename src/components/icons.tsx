...
type IconProps = Omit<ComponentProps<"svg">, "viewBox" | "fill" | "children">;

export function MailIcon(props: IconProps) {
  return (
    <svg aria-hidden viewBox="0 0 24 24" fill="currentColor" className="size-4 shrink-0" {...props}>
...
export function ChevronLeftIcon(props: IconProps) {
  return (
    <svg aria-hidden viewBox="0 0 24 24" fill="currentColor" className="size-4 shrink-0" {...props}>
      <path d="M15.53 4.47a.75.75 0 0 1 0 1.06L8.06 13l7.47 7.47a.75.75 0 1 1-1.06 1.06l-8-8a.75.75 0 0 1 0-1.06l8-8a.75.75 0 0 1 1.06 0Z" />
    </svg>
  );
}
...
export function ChevronRightIcon(props: IconProps) {
  return (
    <svg aria-hidden viewBox="0 0 24 24" fill="currentColor" className="size-4 shrink-0" {...props}>
      <path d="M8.47 4.47a.75.75 0 0 1 1.06 0l8 8a.75.75 0 0 1 0 1.06l-8 8a.75.75 0 1 1-1.06-1.06L15.94 13 8.47 5.53a.75.75 0 0 1 0-1.06Z" />
    </svg>
  );
}
...
export function ExternalLinkIcon(props: IconProps) {
  return (
    <svg aria-hidden viewBox="0 0 24 24" fill="currentColor" className="size-4 shrink-0" {...props}>
      <path d="M13.5 4.5a.75.75 0 0 1 .75-.75h5.25a.75.75 0 0 1 .75.75v5.25a.75.75 0 0 1-1.5 0V6.31l-8.22 8.22a.75.75 0 1 1-1.06-1.06L17.69 5.25h-3.44a.75.75 0 0 1-.75-.75Z" />
      <path d="M5.25 6A2.25 2.25 0 0 0 3 8.25v10.5A2.25 2.25 0 0 0 5.25 21h10.5A2.25 2.25 0 0 0 18 18.75V13.5a.75.75 0 0 0-1.5 0v5.25a.75.75 0 0 1-.75.75H5.25a.75.75 0 0 1-.75-.75V8.25a.75.75 0 0 1 .75-.75h5.25a.75.75 0 0 0 0-1.5H5.25Z" />
    </svg>
  );
}
